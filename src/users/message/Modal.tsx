  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-md w-full text-center border border-blue-200">
        ...
        <h2 className="text-2xl font-extrabold text-[#0a1f44] mb-3 tracking-wide">
          {title}
        </h2>
        ...
        <button
          onClick={onClose}
          className="bg-blue-700 text-white px-6 py-2.5 rounded-full hover:bg-blue-800 transition font-bold text-sm shadow-md"
        >
          Close
        </button>
      </div>
